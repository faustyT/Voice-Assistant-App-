...
event_time_str = st.text_input("Event Time: (Time Format: `HH:MM AM/PM`  &nbsp; (e.g., `09:00 AM`, `03:45 PM`))", help="Enter time in 12-hour format with AM or PM (e.g., 09:00 AM or 03:45 PM)")
...
#event_time_obj = datetime.datetime.strptime(event_time_str, "%H:%M %p").time()
...
if st.button("Set Reminder"):
    if event and recipient_email:
        event_datetime = datetime.datetime.combine(event_date, event_time_str)
